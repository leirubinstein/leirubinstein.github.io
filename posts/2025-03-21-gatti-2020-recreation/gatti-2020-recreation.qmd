...
[**Gatti - 2020 - Can Irrigation Infrastructure Mitigate the Effect of Rainfall Shocks on Conflict**](https://onlinelibrary.wiley.com/doi/full/10.1002/ajae.12092) finds an agricultural link between rainfall and conflict in rural areas and for conflicts about natural resources, popular justice, and law enforcement. 

The researchers measured outcome in total number of conflict incidents or the hyperbolic sine transformation of rice production in a given district-year. The treatment variable was the interaction between rainfall and district-level irrigation infrastructure measured in 1997, before the study period. 

They used a fixed-effect regression model to estimate the interaction between a district’s irrigation capacity and growing season rainfall in the current year. They used baseline irrigation capacity infrastructure in 1997 as an instrumental variable. The researchers chose this method because random assignment of infrastructure wasn’t feasible and using predetermined irrigation capacity helped ensure that the observed effects were driven by weather conditions rather than other factors. 
